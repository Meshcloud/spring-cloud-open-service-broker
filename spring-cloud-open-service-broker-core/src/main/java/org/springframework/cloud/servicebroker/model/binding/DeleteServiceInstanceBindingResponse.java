 ...
 */
public class DeleteServiceInstanceBindingResponse extends AsyncServiceInstanceResponse {
	...
	public static class DeleteServiceInstanceResponseBuilder {
		 ...
		 *
		 * @return the newly constructed {@literal DeleteServiceInstanceBindingResponse}
		 */
