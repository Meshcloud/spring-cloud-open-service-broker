...
public class GetLastBindingOperationResponse {
	...
	GetLastBindingOperationResponse(OperationState state, String description, boolean deleteOperation) {
		this.state = state;
	...
	/**
	 * Create a builder that provides a fluent API for constructing a {@literal GetLastBindingOperationResponse}.
	 *
	 * @return the builder
	 */
	public static GetLastBindingOperationResponseBuilder builder() {
		return new GetLastBindingOperationResponseBuilder();
	}

	@Override
	public final boolean equals(Object o) {
		if (this == o) return true;
		if (!(o instanceof GetLastBindingOperationResponse)) return false;
		GetLastBindingOperationResponse that = (GetLastBindingOperationResponse) o;
	...
	public String toString() {
		return "GetLastBindingOperationResponse{" +
				"state=" + state +
	...
	/**
	 * Provides a fluent API for constructing a {@link GetLastBindingOperationResponse}.
	 */
	public static class GetLastBindingOperationResponseBuilder {
		private OperationState state;
		private String description;
		private boolean deleteOperation;

		GetLastBindingOperationResponseBuilder() {
		}
		 ...
		 * @return the builder
		 */
		public GetLastBindingOperationResponseBuilder operationState(OperationState state) {
			this.state = state;
			return this;
		}
		 ...
		 * @return the builder
		 */
		public GetLastBindingOperationResponseBuilder description(String description) {
			this.description = description;
			return this;
		}
		 ...
		 * @return the builder
		 */
		public GetLastBindingOperationResponseBuilder deleteOperation(boolean deleteOperation) {
			this.deleteOperation = deleteOperation;
			return this;
		}

		/**
		 * Construct a {@link GetLastBindingOperationResponse} from the provided values.
		 *
		 * @return the newly constructed {@literal GetLastBindingOperationResponse}
		 */
		public GetLastBindingOperationResponse build() {
			return new GetLastBindingOperationResponse(state, description, deleteOperation);
		}
	}
}
